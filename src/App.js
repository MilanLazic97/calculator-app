...
function reducer(state, { type, payload }) {
  switch (type) {
    ...
    case ACTIONS.CHOOSE_OPERATION:
      ...
      return {
        ...state,
        previousOperand: evauluate(state),
        operation: payload.operation,
        currentOperand: null
    ...
    case ACTIONS.EVALUATE:
      ...
      return {
        ...
        overwrite: true,
        operation: null,
        currentOperand: evauluate(state),
      }
  }
}
...
function evauluate({ previousOperand, currentOperand, operation }) {
...
function App() {
  ...
  return (
    <div className="calculator-grid">
      ...
      <button className='span-two' onClick={() => dispatch({ type: ACTIONS.CLEAR_DIGIT })}>AC</button>
